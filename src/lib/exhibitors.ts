...
import exhibitor32Photo from '@assets/exhibitors/exhibitor32_photo.jpg';
...
import exhibitor35Photo from '@assets/exhibitors/exhibitor35_photo.jpg';
...
,
{
  exhibitorName: "東京科学大学Meister",
  exhibitorDescription: "大学公認の人力飛行機サークルです！人力飛行機の設計、製作、運用をしています。「鳥人間コンテスト」６度目の優勝へ向け６つの班が団結し、尽力しています。ものづくりやパイロットに興味がある方、大歓迎！",
  exhibitorIcon: exhibitor22Logo,
  exhibitorPhoto: exhibitor22Photo,
  booths: ["サークルブース", "ワークショップ"],
  days: ["4月11日"],
  xLink: "https://x.com/isct_meister",
  instagramLink: "https://www.instagram.com/sciencetokyomeister",
  youtubeLink: "https://m.youtube.com/@meistermovie",
  websiteLink: "https://www.meister.ne.jp/"
}
,
{
...
,
{
  ...
  exhibitorPhoto: exhibitor32Photo,
  booths: ["サークルブース"],
  days: ["4月11日"],
...
,
{
  ...
  exhibitorPhoto: exhibitor35Photo,
  booths: ["サークルブース"],
  days: ["4月11日"],
